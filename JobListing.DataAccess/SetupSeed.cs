...
namespace JobListing.DataAccess
{
    public class SetupSeed
    {
        public static async Task SeedMe(IADOOperations adooperations)
        {
			...
			string applicant = Guid.NewGuid().ToString();
            string stmt2 = $"INSERT INTO Roles (id, RoleName) VALUES('{admin}', 'Admin'), ('{applicant}', 'Applicant');";
